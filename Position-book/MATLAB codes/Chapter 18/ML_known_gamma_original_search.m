function y = ML_known_gamma_original_search(p_cal,hat_bar_tau,bar_gamma,beta_bar,d_0,SNR,P,M,B,c,kappa)
...
y = sum( log(sigma2_b) + ((hat_bar_tau - bar_tau_theory).^2) ./ sigma2_b );