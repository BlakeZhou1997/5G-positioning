...
% head
if head
  fprintf(fid,[ '\footnotesize %% This file is generated by the MATLAB m-file' ...
...
% figure
fprintf(fid,'%%\n');
fprintf(fid,'%% Figure:[width=linewidth]\n');
if iscaption
...
if createview | processview
  ...
  if head
    fprintf(fid,[ '\footnotesize %% This file is generated by laprint.m.\n' ]);
