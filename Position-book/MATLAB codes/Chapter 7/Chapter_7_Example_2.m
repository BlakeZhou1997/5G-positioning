...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EXAMPLE 7.2: Generating transmitted and received signals
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%------------------------------------------------------------------------
...
%------------------------------------------------------------------------
% to evaluate this method, we use example 1  to generate data
%------------------------------------------------------------------------
...
figure;
subplot(211):plot(ts*1e-9*(1:length(tx_sig)),tx_sig,'k');
xlabel('nSec');
title('real part of base band transmitted signal');
%------------------------------------------------------------------------
...
subplot(212):plot(ts*1e-9*(1:length(rx_sig)),rx_sig,'k');
xlabel('nSec');
title('real part of base band received signal');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
